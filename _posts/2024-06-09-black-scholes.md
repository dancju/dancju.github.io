...
$$t=T-\frac{2\tau}{\sigma^2}\,,\quad S_t=Ke^{X_\tau}\,,\quad V_t=e^{\alpha X_\tau+\beta\tau}U_\tau\,,$$
...
In order to eliminate $\frac{\partial U_\tau}{\partial X_\tau}$ term and $U_\tau$ term, we choose $\alpha$ and $\beta$ such that
...
$$U_0=K\max\left(e^{X_0}-1,0\right)\,.$$
